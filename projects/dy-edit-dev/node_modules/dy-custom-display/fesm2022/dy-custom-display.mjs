...
import { Injectable, signal, PLATFORM_ID, Inject, computed, Directive, Input, HostListener, NgModule, Component, input, EventEmitter, Output, model, ViewChild, Pipe } from '@angular/core';
...
import { isPlatformBrowser, CommonModule, NgIf, AsyncPipe, NgForOf } from '@angular/common';
import { Subject, BehaviorSubject, of, combineLatest, takeUntil, filter, switchMap, map, zip, Subscription, finalize, throwError } from 'rxjs';
...
class DyDisplayDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: DyDisplayDirective, deps: [{ token: i0.ElementRef }, { token: i1$1.TranslateService }, { token: TranslationClientService }], target: i0.ɵɵFactoryTarget.Directive }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: DyDisplayDirective, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i0.ElementRef }, { type: i1$1.TranslateService }, { type: TranslationClientService }], propDecorators: { appDyDisplay: [{
                type: Input,
                args: [{ required: true }]
            }] } });
...
class CustomDisplayModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: CustomDisplayModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.10", ngImport: i0, type: CustomDisplayModule, declarations: [DyDisplayDirective], imports: [CommonModule,
            DragDropModule,
            ...
            MatIcon], exports: [DyDisplayDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: CustomDisplayModule, imports: [CommonModule,
            DragDropModule,
            MatButtonToggleModule,
            MatButtonModule,
            MatFormFieldModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: CustomDisplayModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        DyDisplayDirective,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.10", ngImport: i0, type: LoadingComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: LoadingService }], propDecorators: { material: [{
                type: Input
            }] } });
